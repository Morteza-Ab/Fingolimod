...
transcriptome_Eto_and_CTRL <- read.table("clean_transcriptome_Eto_vs_CTRL.txt", header = F, fill = T)
transcriptome_FTY_and_CTRL <- read.table("clean_transcriptome_FTY_vs_CTRL.txt", header = F, fill = T)
transcriptome_FTY_Eto_and_CTRL <- read.table("clean_transcriptome_FTY_Eto_vs_CTRL.txt", header = F, fill = T)
transcriptome_FTY_and_Eto <- read.table("clean_transcriptome_FTY_vs_Eto.txt", header = F, fill = T)
transcriptome_FTY_Eto_and_Eto <- read.table("clean_transcriptome_FTY_Eto_vs_Eto.txt", header = F, fill = T)
transcriptome_FTY_Eto_and_FTY <- read.table("clean_transcriptome_FTY_Eto_vs_FTY.txt", header = F, fill = T)



proteome_Eto_and_CTRL <- read.table("set1.txt", header = F, fill = T)
proteome_FTY_and_CTRL<- read.table("set2.txt", header = F, fill = T)
proteome_FTY_Eto_and_CTRL <- read.table("set3.txt", header = F, fill = T)
proteome_FTY_and_Eto <- read.table("set4.txt", header = F, fill = T)
proteome_FTY_Eto_and_Eto <- read.table("set5.txt", header = F, fill = T)
proteome_FTY_Eto_and_FTY <- read.table("set6.txt", header = F, fill = T)
...
datasets1 <- list(
  transcriptome1 = list(
    Eto_and_CTRL = transcriptome_Eto_and_CTRL,
    FTY_and_CTRL = transcriptome_FTY_and_CTRL,
    FTY_Eto_and_CTRL = transcriptome_FTY_Eto_and_CTRL,
    FTY_and_Eto = transcriptome_FTY_and_Eto,
    FTY_Eto_and_Eto = transcriptome_FTY_Eto_and_Eto,
    FTY_Eto_and_FTY = transcriptome_FTY_Eto_and_FTY
  ),
  proteome1 = list(
    Eto_and_CTRL = proteome_Eto_and_CTRL,
    FTY_and_CTRL = proteome_FTY_and_CTRL,
    FTY_Eto_and_CTRL = proteome_FTY_Eto_and_CTRL,
    FTY_and_Eto = proteome_FTY_and_Eto,
    FTY_Eto_and_Eto = proteome_FTY_Eto_and_Eto,
    FTY_Eto_and_FTY = proteome_FTY_Eto_and_FTY
  )
)
