...
base_url <- "https://raw.githubusercontent.com/Morteza-Ab/Shiny-Senescence/main/"


transcriptome_Eto_vs_CTRL <- openxlsx::read.xlsx(paste0(base_url, "clean_transcriptome_Eto_vs_CTRL.xlsx"))
transcriptome_FTY_vs_CTRL <- openxlsx::read.xlsx(paste0(base_url, "clean_transcriptome_FTY_vs_CTRL.xlsx"))
transcriptome_FTY_Eto_vs_CTRL <- openxlsx::read.xlsx(paste0(base_url, "clean_transcriptome_FTY_Eto_vs_CTRL.xlsx"))
transcriptome_FTY_vs_Eto <- openxlsx::read.xlsx(paste0(base_url, "clean_transcriptome_FTY_vs_Eto.xlsx"))
transcriptome_FTY_Eto_vs_Eto <- openxlsx::read.xlsx(paste0(base_url, "clean_transcriptome_FTY_Eto_vs_Eto.xlsx"))
transcriptome_FTY_Eto_vs_FTY <- openxlsx::read.xlsx(paste0(base_url, "clean_transcriptome_FTY_Eto_vs_FTY.xlsx"))

proteome_Eto_vs_CTRL <- openxlsx::read.xlsx(paste0(base_url, "set1.xlsx"))
proteome_FTY_vs_CTRL <- openxlsx::read.xlsx(paste0(base_url, "set2.xlsx"))
proteome_FTY_Eto_vs_CTRL <- openxlsx::read.xlsx(paste0(base_url, "set3.xlsx"))
proteome_FTY_vs_Eto <- openxlsx::read.xlsx(paste0(base_url, "set4.xlsx"))
proteome_FTY_Eto_vs_Eto <- openxlsx::read.xlsx(paste0(base_url, "set5.xlsx"))
proteome_FTY_Eto_vs_FTY <- openxlsx::read.xlsx(paste0(base_url, "set6.xlsx"))
