                 ...
                 tabPanel("Expression & Enrichment Analysis",
                          fluidPage(
                            sidebarLayout(
                              ...
                              mainPanel(
                                plotOutput("plot", width = "50%", height = "60%")
                              )
                            ),
                            sidebarLayout(
                              sidebarPanel(
                              ...
                              mainPanel(
                                plotOutput("additional_plot", width = "40%", height = "300px")
                              )
                            )
                          )
                 ),
                 ...
                 tabPanel("Feature Selection & Heatmap",
                          fluidPage(
                            sidebarLayout(
                              ...
                              mainPanel(
                                plotOutput("heatmap_plot", width = "40%", height = "300px")
                              )
                            )
                          )
                 )
