                          ...
                          fluidPage(
                            sidebarLayout(
                              sidebarPanel(
                                ...
                                selectInput("data_type_feat", "Select Data Type", choices = c("Transcriptome", "Proteome")),
...
server <- function(input, output, session) {
  ...
  output$dataset_selector_feat <- renderUI({
    if (input$data_type_feat == "Transcriptome") {
  ...
  output$heatmap_plot <- renderPlot({
    ...
    df <- if (input$data_type_feat == "Transcriptome") {
